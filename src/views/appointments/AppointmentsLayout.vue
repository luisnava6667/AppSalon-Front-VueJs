    ...
    <div class="flex justify-between">
        ...
        <div class="flex flex-col space-y-5">
            <div class="flex gap-2 items-center">
                ...
                <button type="button" class="bg-red-600 hover:bg-red-700 p-2 text-white uppercase text-xs font-extrabold rounded-lg" @click="user.logout">Cerrar Sesión</button>
            </div>
